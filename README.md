...
let uzunlik = Number(prompt("To'g'ri to'rtburchak uzunligini kiriting:"));
let eni = Number(prompt("To'g'ri to'rtburchak enini kiriting:"));
let yuza = uzunlik * eni;
alert("To'g'ri to'rtburchak yuzi: " + yuza);


// 3. Aylana radiusi berilgan. Aylananing uzunligini hisoblang.
let radius = Number(prompt("Aylana radiusini kiriting:"));
let aylanUzunlik = 2 * Math.PI * radius;
alert("Aylana uzunligi: " + aylanUzunlik.toFixed(2));


// 4. Berilgan son juft yoki toq ekanligini aniqlang.
let son4 = Number(prompt("Juft/toqlikni tekshirish uchun son kiriting:"));
if (son4 % 2 === 0) {
    alert(son4 + " - Juft son");
} else {
    alert(son4 + " - Toq son");
...
let son5 = Number(prompt("Musbat/manfiylikni tekshirish uchun son kiriting:"));
if (son5 > 0) {
    alert("Musbat son");
} else if (son5 < 0) {
    alert("Manfiy son");
...
let s1 = Number(prompt("1-sonni kiriting:"));
let s2 = Number(prompt("2-sonni kiriting:"));
let s3 = Number(prompt("3-sonni kiriting:"));
...
let son8 = Number(prompt("3 va 5 ga bo'linishini tekshirish uchun son kiriting:"));
...
let n10 = Number(prompt("Yig'indi hisoblash uchun N sonini kiriting:"));
let yigindi10 = 0;
for (let i = 1; i <= n10; i++) {
    yigindi10 += i;
}
...
let n12 = Number(prompt("Ko'paytma uchun N sonini kiriting:"));
let kopaytma12 = 1;
for (let i = 1; i <= n12; i++) {
    kopaytma12 *= i;
}
...
let n13 = Number(prompt("Juft sonlar sonini sanash uchun N kiriting:"));
let juftSoni = 0;
for (let i = 1; i <= n13; i++) {
    if (i % 2 === 0) {
        juftSoni++;
...
let f15_1 = Number(prompt("Funksiya uchun 1-sonni kiriting:"));
let f15_2 = Number(prompt("Funksiya uchun 2-sonni kiriting:"));
...
let f16_son = Number(prompt("Kvadratini hisoblash uchun son kiriting:"));
...
let f17_son = Number(prompt("Kubini hisoblash uchun son kiriting:"));
